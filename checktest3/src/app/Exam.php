...
class Exam
{
    ...
    public function Case3()
    {
        ...
        $sql = 'SELECT MAX(amount) as max_amount from salary where year=2020';
        $ret = $db->query($sql)->fetchColumn();
    ...
    public function Case4()
    {
        ...
        $sql = 'select dept_id from employees where count(id) number=(select max(number) from employees);';
        $ret = $db->query($sql)->fetchColumn();
