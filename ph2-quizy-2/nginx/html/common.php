<div id="common-container">
                ...
                <h1 class="title">ガチで<?php echo $data8[$id-1]["place"];?>の人しか解けない! #<?php echo $data7[$id-1]["big_question_name"];?></h1>
                <div>
                ...
                <div>
                    <a href="tokyo.html" class="tokyo"><?php echo  $data8[$id-1]["place"];?></a>
                </div>
                <div>
                ...
                <div class="gray-color">正答率などの反映は少し遅れることがあります。</div>
